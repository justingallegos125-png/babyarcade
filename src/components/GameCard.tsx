...
const GameCard: React.FC<GameCardProps> = ({ game, isFavorite, onToggleFavorite, onClick }) => {
  return (
    <div 
      ...
      className="group bg-black/40 backdrop-blur-sm border-2 transition-all cursor-pointer relative border-accent/20 hover:border-accent rounded-2xl overflow-hidden hover:box-glow"
    >
